...
If there are multiple AVRs of the same type its important to edit their "friendly name" in the Denon/Marantz amp. Settings → Network → Friendly Name. Or in the HEOS app Settings -> My Devices -> AVRs -> Advanced ->Device Settings -> Device Name
